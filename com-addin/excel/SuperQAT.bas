...
'==============================================================================
' SuperQAT v3.0.0 - Excel COM Add-in
' Executes ALL 1,080 Excel ribbon commands via CommandBars.ExecuteMso
'
' INSTALL:
...
'   5. Close VBA Editor
'   6. File > Save As > Excel Add-In (.xlam)
'      Save to: %appdata%\Microsoft\AddIns\SuperQAT.xlam
'   7. File > Options > Add-Ins > Manage: Excel Add-ins > Go
'      Check "SuperQAT" and click OK.
'==============================================================================
Option Explicit

Public Const CMD_COUNT As Long = 1080
